...
NDP_RESOLVE_STALE      = "NDP-RESOLVE-STALE"
...
NDP_ANNOUNCE_PROFILE_VIOLATION = "NDP-ANNOUNCE-PROFILE-VIOLATION"
NDP_ANNOUNCE_STALE             = "NDP-ANNOUNCE-STALE"

# ── Graph ─────────────────────────────────────────────────────────────────────
NDP_GRAPH_SEQ_ROLLBACK = "NDP-GRAPH-SEQ-ROLLBACK"
NDP_GRAPH_SEQ_GAP      = "NDP-GRAPH-SEQ-GAP"
# alpha.11 additions (GraphFrame §3.3 topology-snapshot format):
...
NDP_STATE_UNAVAILABLE    = "NDP-STATE-UNAVAILABLE"
NDP_STATE_CORRUPT        = "NDP-STATE-CORRUPT"
...
NDP_ERROR_TO_NPS_STATUS: dict[str, str] = {
    ...
    NDP_RESOLVE_STALE:                NPS_CLIENT_NOT_FOUND,
    ...
    NDP_ANNOUNCE_PROFILE_VIOLATION:   NPS_AUTH_FORBIDDEN,
    NDP_ANNOUNCE_STALE:               NPS_CLIENT_NOT_FOUND,
    ...
    NDP_STATE_UNAVAILABLE:            NPS_SERVER_UNAVAILABLE,
    NDP_STATE_CORRUPT:                NPS_SERVER_INTERNAL,
}
