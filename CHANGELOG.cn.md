...
- **`nps_sdk.nip.x509.oids` — IANA PEN 65715（Breaking，CR-0004）**：`NpsX509Oids.LAB_ACACIA_PEN_ARC` 从 `"1.3.6.1.4.1.99999"` 更新为 `"1.3.6.1.4.1.65715"`。在临时弧下签发的证书必须吊销并重新签发。
...
[1.0.0-alpha.8]: https://gitee.com/labacacia/NPS-sdk-py/releases/tag/v1.0.0-alpha.8
